...
/* USER CODE BEGIN PV */
const uint8_t Private_Key[48] = {
  0x6D,0x4A,0x3C,0x2F,0x9B,0xD1,0x8E,0xFA,
  0x1A,0x5B,0x7C,0xE3,0x4F,0x90,0x2D,0xB7,
  0x33,0x81,0xC5,0x66,0xA2,0x7F,0x18,0x9D,
  0x22,0xAB,0x5E,0x61,0xF0,0x3C,0xD7,0x49,
  0x0E,0xB4,0x6F,0xA9,0x58,0x12,0x3D,0xC8,
  0xE1,0x7A,0x94,0x5B,0x2F,0x80,0xB6,0xD3
};
...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
// Private key (never exposed outside Secure World)
